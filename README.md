...
![Carmen](https://en.wikipedia.org/wiki/File:Carmen_Sandiego.png)
...
# Connect to carmen
\c carmen
\i ~/path/to/this/file/on/your/computer/world.SQL (remeber pwd is your friend!)
```
...
## Due tonight (4/24)
## Outcomes HW is due on Wednesday
